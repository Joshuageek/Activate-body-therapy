...
export default function ChatWidget() {
  ...
  const trackMessage = (message: string, type: 'user' | 'assistant') => {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      trackMessage(fullResponse, 'assistant');
      ...
      if (retryCount < 2) {
        ...
        setTimeout(() => sendMessage(), 1000 * (retryCount + 1));
        return;
      }
    ...
    <>
      ...
      <style>{`
        ...
        .abt-bubble:hover {
          ...
          box-shadow: 0 6px 30px rgba(27,67,50,0.45);
        }
        ...
        .abt-window {
          ...
          animation: abt-pop 0.22s cubic-bezier(0.34, 1.56, 0.64, 1);
        }
        ...
        .abt-messages::-webkit-scrollbar {
          width: 4px;
        }
        .abt-messages::-webkit-scrollbar-track {
          background: transparent;
        }
        .abt-messages::-webkit-scrollbar-thumb {
          background: #d0e8da;
          border-radius: 4px;
        }
        ...
        .abt-msg {
          ...
          gap: 8px;
          max-width: 88%;
          animation: abt-fadein 0.18s ease;
        }
        ...
        .abt-typing span {
          ...
          border-radius: 50%;
          background: #b0c4b8;
          animation: abt-bounce 1.2s infinite;
        }
