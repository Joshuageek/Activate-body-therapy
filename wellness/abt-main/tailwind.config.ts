...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "usawa-green-light": "hsl(177, 62%, 64%)", // soft / airy
        "usawa-green-soft": "hsl(177, 49%, 50%)",  // balanced (MAIN UI COLOR)
        "usawa-green-dark": "hsl(177, 72%, 50%)",  // dark / emphasis
        "usawa": "hsl(156, 77%, 71%)", 
  ...
  plugins: [
    ...
    matchUtilities(
      {
        "text-shadow": (value: any) => ({ textShadow: value }),
      },
